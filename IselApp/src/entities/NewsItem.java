...
public class NewsItem implements Serializable{
	...
	public NewsItem (String news_classFullname, int news_classId, int news_id, String news_title, String news_when, String news_content, boolean news_isViewed) throws ParseException {
